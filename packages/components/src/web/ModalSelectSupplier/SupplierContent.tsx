...
import SupplierApi from "./_api";

export interface ISupplierContentRef {
  onSubmit?: () => void;
}
...
const SupplierContent = (props: IProps, ref) => {
  const {
    title,
    value,
    rowSelectionProps = {},
...
export default forwardRef<ISupplierContentRef, IProps>(SupplierContent);

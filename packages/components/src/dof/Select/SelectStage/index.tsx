...
export interface SelectStageProps extends SelectProps {
...
const SelectStage = forwardRef<HTMLSelectElement, SelectStageProps>(
  (
    ...
    const { data } = useQuery({
      queryKey: ["get-stage-list", searchDebounce, paramsApi],

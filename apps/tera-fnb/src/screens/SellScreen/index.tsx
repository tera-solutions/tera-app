...
const menuItems: MenuItem[] = [
  ...
  { id: 'order_return', iconName: 'keyboard-return', label: 'Khách trả hàng' },
  {
    id: 'shipping',
    iconName: 'truck-delivery-outline',
    label: 'Quản lý giao hàng',
  },
  { id: 'sale_store', iconName: 'shopping', label: 'Bán tại cửa hàng' },
  {
    id: 'temporary_order',
    ...
    <SafeAreaView style={SaleStyles.safeArea} edges={['top']}>
      <View style={SaleStyles.header}>
        ...
        >
          ...
          <Text style={SaleStyles.headerTitle}>Bán hàng</Text>
        </TouchableOpacity>
        ...
        <View style={SaleStyles.headerActions}>
          <TouchableOpacity style={SaleStyles.headerButton}>
            ...
            <Text style={SaleStyles.headerButtonText}>Bán nhanh</Text>
          </TouchableOpacity>
          <TouchableOpacity style={SaleStyles.headerButton}>
            <Icon source="clipboard-text" size={24} color={colors.gray} />
            <Text style={SaleStyles.headerButtonText}>Đơn hàng</Text>
          </TouchableOpacity>
          <TouchableOpacity
      ...
      >
        ...
        <View style={SaleStyles.createOrderCard}>
          ...
          <Text style={SaleStyles.createOrderText}>Tạo đơn và giao hàng</Text>
        </View>

...
const ParentStudentFormModal = ({ open, onClose, id, type }: IModalProps) => {
  ...
  const { data, isLoading } = ParentStudentService.useParentStudentDetail({
    id,
  });
  ...
  const titleMap: Record<string, string> = {
    create: t("parent_student.create"),
    update: t("parent_student.update"),
    detail: t("parent_student.detail"),
  };
  ...
  return (
    ...
    >
      <Spin spinning={isLoading}>
        {isDetail ? (
          <ParentStudentDetailView link={link} />
        ) : (
          <ParentStudentForm
            ref={actionRef}
            dataDetail={link}
...
export default ParentStudentFormModal;

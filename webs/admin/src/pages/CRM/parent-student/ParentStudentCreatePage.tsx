...
const ParentStudentCreatePage = observer(() => {
      ...
      <div className="w-full max-w-3xl mx-auto max-xmd:pb-[60px]">
        ...
        <div className="bg-white rounded-[5px] w-full p-4">
          <ParentStudentForm
            ref={actionRef}
            type="create"
            onSuccess={() => navigate(PARENT_STUDENT_PAGE_URL.list.path)}
          />
        </div>
      </div>
    </div>
...
export default ParentStudentCreatePage;

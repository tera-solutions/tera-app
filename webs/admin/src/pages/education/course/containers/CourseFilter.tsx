...
const CourseFilter = ({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 xmd:flex-nowrap">
      {/* Thời lượng + Giá + Người tạo — CHỈ hiện desktop (mobile đưa vào modal "Lọc") */}
      ...
      {/* Sắp xếp luôn hiện (chung hàng search+Lọc trên mobile); Ngày tạo CHỈ desktop — mobile vào modal */}

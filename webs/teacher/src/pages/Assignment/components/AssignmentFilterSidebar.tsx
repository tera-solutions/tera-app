...
export interface AssignmentFilterDraft {
  class_id?: number;
  level_id?: number;
}

interface AssignmentFilterSidebarProps {
  draft: AssignmentFilterDraft;
  onChange: (patch: Partial<AssignmentFilterDraft>) => void;
  onReset: () => void;
...
export default AssignmentFilterSidebar;

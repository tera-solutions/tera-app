...
import { formatAmountInput, isSubmittable, parseAmountInput, validateAmount } from "../_utils";
...
const WithdrawForm = ({
  ...
  return (
    <Card className="xmd:p-5" animated={false}>
      <p className="mb-4 text-base font-semibold text-slate-800">Nhập thông tin rút tiền</p>
      ...
      <div className="mb-1 flex items-center justify-between gap-2">
        ...
        <button
          type="button"
          onClick={() => onAmountChange(balance > 0 ? balance : null)}
      ...
      <label className="mt-3 block text-sm text-slate-500" htmlFor="withdraw-note">

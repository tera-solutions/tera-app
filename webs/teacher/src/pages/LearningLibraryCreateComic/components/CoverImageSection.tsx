...
const CoverImageSection = ({ title, gradient, customCoverUrl, onUpload, onRemoveCustom }: CoverImageSectionProps) => {
  const inputRef = useRef<HTMLInputElement>(null);

  return (
    <Card>
      <p className="mb-3 text-sm font-semibold text-slate-800">6. Ảnh bìa truyện</p>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <p className="text-xs text-slate-500">Tải lên ảnh bìa hoặc kéo thả vào đây</p>

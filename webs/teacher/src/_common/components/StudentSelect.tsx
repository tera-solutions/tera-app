...
/** Searchable student picker — types into the box to filter server-side. */
const StudentSelect = ({ value, onChange, placeholder = "Tìm học viên", className }: StudentSelectProps) => (
  <AsyncSearchSelect
    value={value}
    onChange={onChange}

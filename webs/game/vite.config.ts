...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        "@tera/game/pages": path.resolve(__dirname, "./src/pages/"),
        "@tera/game/assets": path.resolve(__dirname, "./src/assets/"),
        "@tera/game/routers": path.resolve(__dirname, "./src/routers/"),
        "@tera/game/states": path.resolve(__dirname, "./src/states/"),
        "@tera/game/engine": path.resolve(__dirname, "./src/engine/"),
        "@tera/game/screen": path.resolve(__dirname, "./src/screen/"),
        "@tera/game/ui": path.resolve(__dirname, "./src/ui/"),
        "@tera/game/_common": path.resolve(__dirname, "./src/_common/"),

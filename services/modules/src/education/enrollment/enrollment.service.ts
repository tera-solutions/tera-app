...
// QUERY
export const useEnrollmentList = (payload: ListPayload, options?: QueryHookOptions) => {
...
export const useEnrollmentDetail = (payload: DetailPayload, options?: QueryHookOptions) => {
  return useQueryAdapter({
